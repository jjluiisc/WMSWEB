 ...
 */
public class CancelaTerminoOrdenSurtidoPedidoCommand implements WebCommandInterface {
    static Logger log = Logger.getLogger(CancelaTerminoOrdenSurtidoPedidoCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response, DatabaseServices ds) throws WebException {
        try {
            ...
            try {
                ...
                cancelar.cancelaTermino(compania, usuario, flsurtido);
