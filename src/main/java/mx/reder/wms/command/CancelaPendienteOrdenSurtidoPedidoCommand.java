 ...
 */
public class CancelaPendienteOrdenSurtidoPedidoCommand implements WebCommandInterface {
    static Logger log = Logger.getLogger(CancelaPendienteOrdenSurtidoPedidoCommand.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response, DatabaseServices ds) throws WebException {
        try {
            ...
            try {
                ...
                cancelar.cancelaPendiente(compania, usuario, flsurtido);
