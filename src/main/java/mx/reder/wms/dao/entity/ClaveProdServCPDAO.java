...
public class ClaveProdServCPDAO implements DatabaseRecord, DatabaseRecordABC, java.io.Serializable {
    public String clave = "";
    public String descripcion = "";
    public String similares = "";
    public String materialpeligroso = "";

    public ClaveProdServCPDAO() {
    }

    public ClaveProdServCPDAO(String clave) {
        this.clave = clave;
    }

    @Override
    public String getTable() {
        return "ClaveProdServCP";
    }
